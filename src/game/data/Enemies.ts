...
export const ENEMIES: Record<EnemyType, EnemyDefinition> = {
  [EnemyType.Slime]: {
    ...
    attackSpeed: 1500, color: '#4caf50', size: 20, behavior: 'chase',
  ...
  [EnemyType.Wolf]: {
    ...
    attackSpeed: 1200, color: '#6d4c41', size: 24, behavior: 'chase',
  ...
  [EnemyType.Boar]: {
    ...
    attackSpeed: 1400, color: '#5d4037', size: 28, behavior: 'chase',
    biomes: [Biome.Forest, Biome.Plains],
    loot: [
  ...
  [EnemyType.Spider]: {
    ...
    attackSpeed: 1000, color: '#212121', size: 18, behavior: 'chase',
  ...
  [EnemyType.Skeleton]: {
    ...
    attackSpeed: 1300, color: '#e0e0e0', size: 24, behavior: 'chase',
  ...
  [EnemyType.Bat]: {
    ...
    attackSpeed: 800, color: '#4a148c', size: 14, behavior: 'chase',
  ...
  [EnemyType.Golem]: {
    ...
    attackSpeed: 2000, color: '#78909c', size: 36, behavior: 'patrol',
  ...
  [EnemyType.DarkKnight]: {
    ...
    attackSpeed: 1400, color: '#1a1a2e', size: 28, behavior: 'chase',
  ...
  [EnemyType.Dragon]: {
    ...
    attackSpeed: 2500, color: '#b71c1c', size: 48, behavior: 'ranged',
  ...
  [EnemyType.SlimeKing]: {
    ...
    attackSpeed: 1600, color: '#1b5e20', size: 40, behavior: 'patrol',
    biomes: [Biome.Forest],
    loot: [
  ...
  [EnemyType.ShadowLord]: {
    ...
    attackSpeed: 1800, color: '#0d0d2b', size: 44, behavior: 'ranged',
    biomes: [Biome.Cave],
    loot: [
